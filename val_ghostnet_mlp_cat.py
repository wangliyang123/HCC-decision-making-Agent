...
def plot_roc(all_labels, all_probs, num_classes):
    ...
    plt.savefig('/mnt/newdisk/KJY/多模态/Cancer_Embolus/ghostnet_mlp_cat/result/ROC_Curve_val.png', dpi=1000)
...
if __name__ == "__main__":
    ...
    fusion_model.load_state_dict(torch.load('/mnt/newdisk/KJY/多模态/Cancer_Embolus/ghostnet_mlp_cat/model/best_model.pth'))
    ...
    plt.savefig('/mnt/newdisk/KJY/多模态/Cancer_Embolus/ghostnet_mlp_cat/result/Confusion_Matrix_val.png', dpi=1000)
