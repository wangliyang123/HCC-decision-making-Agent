...
def train_fusion_model(fusion_model, train_loader, val_loader, num_epochs=30):
    if not os.path.exists('/mnt/newdisk/KJY/多模态/Cancer_Embolus/densenet_mlp_cat/model'):
        os.makedirs('/mnt/newdisk/KJY/多模态/Cancer_Embolus/densenet_mlp_cat/model')
    if not os.path.exists('/mnt/newdisk/KJY/多模态/Cancer_Embolus/densenet_mlp_cat/result'):
        os.makedirs('/mnt/newdisk/KJY/多模态/Cancer_Embolus/densenet_mlp_cat/result')
    ...
    for epoch in range(num_epochs):
        ...
        if acc > best_acc:
            ...
            torch.save(best_model_weights, '/mnt/newdisk/KJY/多模态/Cancer_Embolus/densenet_mlp_cat/model/best_model1.pth')
    ...
    plt.savefig("/mnt/newdisk/KJY/多模态/Cancer_Embolus/densenet_mlp_cat/result/loss.png", dpi=1000)
    ...
    plt.ylabel('Accuracy')
    plt.legend()
    plt.savefig("/mnt/newdisk/KJY/多模态/Cancer_Embolus/densenet_mlp_cat/result/accuracy.png", dpi=1000)

if __name__ == "__main__":
    device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu')
    clf_model1 = models.densenet121(pretrained=True)
