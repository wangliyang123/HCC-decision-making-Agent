...
plt.savefig('./result/Confusion_Matrix_RF_val.png', dpi=1000)
plt.close()
...
plt.savefig('./result/ROC_Curve_RF_val.png', dpi=1000)
plt.close()
...
plt.savefig('./result/Calibration_Curve_RF_val.png', dpi=1000)
plt.close()
...
plt.savefig('./result/SHAP_Summary_RF_val.png', dpi=1000)
plt.close()
...
plt.ylabel('Actual', fontsize=14)
plt.title('Confusion Matrix ', fontsize=16)
plt.savefig('./result/Confusion_Matrix_RF_test.png', dpi=1000)
plt.close()
...
plt.title('ROC Curves ')
plt.legend(loc='lower right')
plt.savefig('./result/ROC_Curve_RF_test.png', dpi=1000)
plt.close()
...
plt.title('Calibration Curves ')
plt.legend(loc='upper left')
plt.savefig('./result/Calibration_Curve_RF_test.png', dpi=1000)
plt.close()
...
plt.savefig('./result/SHAP_Summary_RF_test.png', dpi=1000)
plt.close()
